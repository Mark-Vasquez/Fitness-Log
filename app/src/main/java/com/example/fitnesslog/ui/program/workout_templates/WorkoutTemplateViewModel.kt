...
class WorkoutTemplateViewModel(
    ...
    private val exerciseTemplateUseCases: com.example.fitnesslog.domain.use_case.exercise_template.ExerciseTemplateUseCases
) : ViewModel() {
    ...
    private fun updateWorkoutTemplateExercisesOrder(workoutTemplateExercises: List<com.example.fitnesslog.domain.model.WorkoutTemplateExerciseWithName>) {
        viewModelScope.launch {
