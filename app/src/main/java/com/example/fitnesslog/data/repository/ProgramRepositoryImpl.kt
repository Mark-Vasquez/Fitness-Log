...
class ProgramRepositoryImpl(
    ...
    override fun getAllProgramsOrderedBySelected(): Flow<Resource<List<com.example.fitnesslog.domain.model.ProgramWithWorkoutCount>>> {
        return dao.getAllProgramsOrderedBySelected()
            .map { Resource.Success(it) as Resource<List<com.example.fitnesslog.domain.model.ProgramWithWorkoutCount>> }
